...
BCAA2017data_newbit <- read_csv("C:/@data/GitHub/housing-data-visualization-project/data/BCAA/BC Stats - Housing Policy Analysis Fraser Valley.csv", 
                        col_types = cols(PID = "c"))
...
BCAA2017data_newbit <- read_csv("C:/@data/GitHub/housing-data-visualization-project/data/BCAA/BC Stats - Housing Policy Analysis Greater Vancouver.csv", 
                        col_types = cols(PID = "c"))
...
BCAA2017data_newbit <- read_csv("C:/@data/GitHub/housing-data-visualization-project/data/BCAA/BC Stats - Housing Policy Analysis Northern BC.csv", 
                        col_types = cols(PID = "c"))
...
BCAA2017data_newbit <- read_csv("C:/@data/GitHub/housing-data-visualization-project/data/BCAA/BC Stats - Housing Policy Analysis Thompson Okanagan.csv", 
                        col_types = cols(PID = "c"))
...
BCAA2017data_newbit <- read_csv("C:/@data/GitHub/housing-data-visualization-project/data/BCAA/BC Stats - Housing Policy Analysis Vancouver Island.csv", 
                        col_types = cols(PID = "c"))
